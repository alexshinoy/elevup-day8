...
export default function Navbar({ searchTerm, setSearchTerm }) {
  ...
  // New state to toggle the profile dropdown menu
  ...
  // Reusable style for the dropdown menu links
  const menuItemStyle = {
    display: 'flex', 
    alignItems: 'center', 
    gap: '15px', 
  ...
  return (
    <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem', borderBottom: `1px solid var(--border)`, backgroundColor: 'var(--bg-surface)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
        <Menu style={{ cursor: 'pointer', color: 'var(--text-main)' }} />
        ...
        {isProfileOpen && (
          <div style={{ 
            ...
            <div style={{ padding: '8px 0' }}>
              <div style={menuItemStyle} className="dropdown-item">
                <UserCircle size={20} /> Your channel
              </div>
              <div style={menuItemStyle} className="dropdown-item">
                <Video size={20} /> YouTube Studio
              </div>
              ...
              <div style={menuItemStyle} className="dropdown-item" onClick={() => setIsProfileOpen(false)}>
